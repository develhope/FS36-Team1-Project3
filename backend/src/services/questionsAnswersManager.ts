...
export const questionsAnswersManager = async (arg: string, cbGetQuestionsByArgument: (arg: string) => Promise<any[]>, cbGetAnswersByQuestionId: (questionId: number) => Promise<any[]>): Promise<QuestionsAndAnswers[]> => {
