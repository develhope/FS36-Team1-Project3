...
import { useArgumentContext } from "../context/ArgumentContext";
...
const {response, error} = useGetQuestion("html")
console.log(`
	la risposta è ${response}, 
	l'errroe è ${error}`)

return (
	<div className="w-full h-screen bg-gradient-to-b from-purple-200 via-purple-400 to-purple-600">
		<div className="flex justify-center items-center h-full">
			<h1 className="text-3xl font-bold text-white">Quiz Page</h1>
			<p className="text-lg text-white mt-4">Category: {}</p>
			{/* Render questions or other content here */}
		</div>
	</div>
)
}
